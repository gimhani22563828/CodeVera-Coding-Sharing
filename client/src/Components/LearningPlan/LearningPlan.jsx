        ...
        addTopicToPlan({
          ...
          topicData: {
            ...
            targetCompletionDate:
              values.targetCompletionDate?.format("YYYY-MM-DD") || null,
          },
        })
      );
  ...
  const showTopicModal = (mode = "create", topic = null, planId = null) => {
    ...
    if (mode === "edit") {
      topicForm.setFieldsValue({
        ...
        targetCompletionDate: topic.targetCompletionDate
          ? moment(topic.targetCompletionDate)
          : null,
      });
    }
  };
  //display resource modal
    ...
    <div className="learning-plan-container">
      ...
      {learningPlan.plans?.length === 0 ? (
        <div className="empty-state">
          ...
          <Button className="primary-button" onClick={() => showPlanModal()}>
            Create First Plan
          </Button>
        </div>
      ) : (
        <Collapse accordion className="plan-accordion">
                  ...
                  <div className="plan-title-container">
                    <CheckCircleOutlined
                      style={{
                        fontSize: "1.5rem",
                        color:
                          getCompletionPercentage(plan.topics) === 100
                            ? "#7c3aed"
                            : "#e0e0e0",
                      }}
                    />
                    <span className="plan-title-text">{plan.title}</span>
                  </div>
                  <Space>
                    <Button
                      shape="circle"
                ...
                <div className="progress-container">
                  <div className="progress-bar">
                    <div
                      ...
                      style={{
                        width: `${getCompletionPercentage(plan.topics)}%`,
                      }}
                    />
                  </div>
                  <div className="flex justify-between text-sm mt-2">
                    ...
                    <span className="text-gray-600">
                      {plan.topics?.filter((t) => t.completed).length} of{" "}
                      {plan.topics?.length} milestones
                    </span>
                  </div>
                </div>
                ...
                <div className="topic-section">
                  ...
                  {plan.topics?.length > 0 ? (
                          ...
                          <div className="topic-main">
                            ...
                            <div className="topic-actions">
                              <Button
                                ...
                                icon={<PlusOutlined />}
                                onClick={() =>
                                  showResourceModal("create", null, topic.id)
                                }
                              />
                              <Button
                                size="small"
                          ...
                          <div className="topic-meta">
                            {topic.targetCompletionDate && (
                              <Tag
                                ...
                                className="status-tag tag-purple"
                              >
                                {new Date(
                                  topic.targetCompletionDate
                                ).toLocaleDateString()}
                            ...
                            {!topic.completed &&
                              topic.targetCompletionDate &&
                              new Date(topic.targetCompletionDate) <
                                new Date() && (
                                <Tag className="status-tag tag-red">
                                  Overdue
                                </Tag>
                              )}
                          </div>
                    ...
                    <div className="empty-state-small">
                      <p className="text-gray-500">No milestone added yet</p>
                      <Button
                        type="text"
                        icon={<PlusOutlined />}
                        onClick={() => showTopicModal("create", null, plan.id)}
      ...
      <Modal
        ...
        footer={[
          <Button
            key="back"
            onClick={() => setPlanModal({ ...planModal, visible: false })}
          >
            Cancel
          </Button>,
      ...
      >
        <Form
          form={planForm}
          onFinish={
            planModal.mode === "create" ? handleCreatePlan : handleUpdatePlan
          }
          layout="vertical"
        >
          <Form.Item
      ...
      {/* Topic Modal */}
      <Modal
        title={topicModal.mode === "create" ? "New Milestone" : "Edit Topic"}
        ...
        footer={[
          <Button
            key="back"
            onClick={() => setTopicModal({ ...topicModal, visible: false })}
          >
            Cancel
          </Button>,
          <Button key="submit" type="primary" onClick={() => planForm.submit()}>
      ...
      >
        <Form
          form={topicForm}
          onFinish={
            topicModal.mode === "create" ? handleCreateTopic : handleUpdateTopic
          }
          layout="vertical"
        >
          <Form.Item
          ...
          >
            <TextArea rows={3} placeholder="Describe the milestone content" />
          </Form.Item>
      ...
      <Modal
        title={
          resourceModal.mode === "create" ? "New Resource" : "Edit Resource"
        }
